        ...
        return (
            <div className="w-full items-center bg-white">
                <div className="text-center text-4xl font-bold py-8">
                    ...
                    <div>
                        <Link to={paths.graduation.fauna.root.getHref()} className="text-blue-500 text-lg">Back to message board</Link>
                    </div>
                </div>
            </div>
        );
            ...
            <div>
                ...
                <Dialog open={
                    ...
                    <DialogContent className='w-screen'>
                        ...
                        <div className="border-8 border-[#CDDF90] rounded-md p-4 shadow-xl overflow-auto max-h-[80vh]">
                            {
                                finalSave?.name && <div>
