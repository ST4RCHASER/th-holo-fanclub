...
const loadPDF = async (url: string, setBook: React.Dispatch<React.SetStateAction<PDFBook | null>>): Promise<void> => {
    ...
    const getPage = async (
        ...
        try {
            ...
            const renderContext = { canvasContext: context, transform, viewport, background: null };
...
const FlipbookViewer: React.FC = () => {
    ...
    useEffect(() => {
        loadPDF('https://mozilla.github.io/pdf.js/web/compressed.tracemonkey-pldi-09.pdf', setBook);
        // Keyboard event
